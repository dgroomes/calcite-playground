...
/**
 * This is copied from {@link org.apache.calcite.interpreter.Interpreter}.
 * Interpreter.
 *
 ...
 * assembled.
 */
public class CustomInterpreter extends AbstractEnumerable<@Nullable Object[]>
    ...
    public CustomInterpreter(DataContext dataContext, RelNode rootRel) {
        this.dataContext = requireNonNull(dataContext, "dataContext");
        final RelNode rel = optimize(rootRel);
        final CompilerImpl compiler =
                new CustomNodes.CoreCompiler(this, rootRel.getCluster());
    ...
    /** Implementation of {@link Sink} using a {@link ArrayDeque}. */
    ...
    /** Implementation of {@link Source} using a {@link ArrayDeque}. */
    ...
    /**
     * Walks over a tree of {@link RelNode} and, for each,
     * creates a {@link Node} that can be
    ...
    static class CompilerImpl extends RelVisitor
        ...
        @NotOnlyInitialized
        protected final CustomInterpreter interpreter;
        ...
        CompilerImpl(@UnknownInitialization CustomInterpreter interpreter, RelOptCluster cluster) {
            this.interpreter = interpreter;
            this.scalarCompiler = new CustomJaninoRexCompiler(cluster.getRexBuilder());
        }
