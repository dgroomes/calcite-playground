...
/**
 * This is copied from {@link CustomJaninoRexCompiler}.
 * <p>
...
public class CustomNodes {
     ...
     */
    public static class CoreCompiler extends CustomInterpreter.CompilerImpl {
        CoreCompiler(@UnknownInitialization CustomInterpreter interpreter, RelOptCluster cluster) {
