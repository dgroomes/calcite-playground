...
/**
 * This is copied from {@link org.apache.calcite.interpreter.CustomJaninoRexCompiler}.
 * <p>
 ...
 */
public class CustomJaninoRexCompiler implements CustomInterpreter.ScalarCompiler {
    private final RexBuilder rexBuilder;

    public CustomJaninoRexCompiler(RexBuilder rexBuilder) {
        this.rexBuilder = rexBuilder;
    }

    @Override
    public Scalar.Producer compile(List<RexNode> nodes,
    ...
    static Scalar.Producer getScalar(ClassDeclaration expr, String s)
        ...
        ClassLoader classLoader =
                Objects.requireNonNull(CustomJaninoRexCompiler.class.getClassLoader(), "classLoader");
        try {
